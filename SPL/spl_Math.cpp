...
void build_table()
{
	unsigned short i;
	float f;
//AliSoft 26/12/2002	unsigned int *fi = &f;	/* to access the bits of a float in  */
	unsigned int *fi = (unsigned int *)&f;	/* to access the bits of a float in  */
...
float fsqrt(float n)
{
//AliSoft 26/12/2002	unsigned int *num = &n;	/* to access the bits of a float in C
	unsigned int *num = (unsigned int *)&n;	/* to access the bits of a float in C
